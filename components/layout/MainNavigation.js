...
function MainNavigation() {
  ...
  return (
    <header className={classes.header}>
      {popupToggle && <Button text1="Sign" text2="in" maxWidth="50px" onClickHandler={() => toggleMenuHide()} />}
      {popupToggle && <Button text1="Sign" text2="up" maxWidth="50px" onClickHandler={() => toggleMenuHide()} />}
      <HamMenu toggleMenuHide={() => toggleMenuHide()} />
      <div className={classes.logo}>Cookie Clicker</div>
      <nav>
        <ul>
          <li>
